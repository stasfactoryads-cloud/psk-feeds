...
PROJECTS = {
    ...
    'ЖК «Industrial AVENIR»': {
        ...
        'usp': [
            'Квартиры с чистовой отделкой — заезжай и живи',
            'Рядом метро Кировский Завод',
            'Апарт-формат от надёжного застройщика',
        ],
        'descriptions': {
            1: [
                'Квартира с отделкой {area} кв.м рядом с метро. ЖК «Industrial AVENIR» — готовые квартиры у Кировского Завода. Заезжай и живи! Этаж {floor}/{floors}. Скидка {discount}!',
                'Готовая квартира {area} кв.м — отличная инвестиция! ЖК «Industrial AVENIR» у метро. Чистовая отделка, сдача скоро. Комфорт-класс от ГК ПСК. Скидка {discount}!',
            ],
            2: [
                'Двушка с отделкой {area} кв.м в «Industrial AVENIR». Метро Кировский Завод рядом. Готовая квартира — въезжай без ремонта. Комфорт-класс по доступной цене. Скидка {discount}!',
            ],
        },
        'render_images': [],  # Нужно получить список файлов
    },
    ...
    'ЖК «Ladozhsky AVENIR»': {
        ...
        'descriptions': {
            1: [
                'Готовая квартира {area} кв.м — дом сдан! ЖК «Ladozhsky AVENIR» у метро Ладожская. Чистовая отделка, заезжай сегодня. Бизнес-класс по цене комфорта. Скидка {discount}!',
                'Квартира с ключами — {area} кв.м, этаж {floor}. Дом сдан, отделка готова. «Ladozhsky AVENIR» — бизнес-класс у Ладожской. Без ожидания, без ремонта. Скидка {discount}!',
            ],
        },
        'render_images': [],  # Нужно получить список файлов
    },
